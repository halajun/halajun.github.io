...
* I am a senior researcher at the [Institute of Computer Graphics and Vision](https://www.tugraz.at/institute/icg/home) (ICGV), Technische Universität Graz (TU Graz), working with Prof. [Friedrich Fraundorfer](https://www.tugraz.at/institute/icg/research/team-fraundorfer/people/friedrich-fraundorfer/)'s group. Prior to this, I was a post-doc researcher hosted by the division of [Robotics, Perception and Learning](https://www.kth.se/is/rpl) (RPL), at KTH Royal Institute of Technology. I obtained my Ph.D. degree from the Australian National University (ANU), M.Sc.Eng. and B.Eng. degrees from Northwestern Polytechnical University (NPU).

* My research interests lie in the area of robotics and vision, particularly in visual odometry/SLAM (simultaneous localization and mapping), structure from motion and 3D vision, etc, which covers wide applications including advanced driver-assistance system (ADAS), virtual/argumented/mixed reality (V/A/MR), digital twin, and robot navigation, to name a few. I also have experiences in AUV (autonomous underwater vehicle) localization and bathymetry mapping, using optical (camera) and acoustic (multi-beam, side-scan sonar) sensors.  At ICGV, I mainly work on projects regarding aerial navigation and scene reconstruction using event camera, and also indoor visual tracking and 3D mapping using standard cameras.
...
* I recently relocate from Stockholm to Graz, Austria. (13 Dec 2023)
