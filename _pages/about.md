...
* I am a senior research staff at [IVC](https://ivc.tugraz.at), TU Graz, working in [Prof. F. Fraundorfer's group](https://ivc.tugraz.at/research-teams/team-fraundorfer/). Prior to this, I was a post-doc researcher hosted by [RPL](https://www.kth.se/is/rpl), KTH, Sweden. I obtained my Ph.D. degree in Robotic Vision, from the Australian National University ([ANU](https://www.anu.edu.au)). My research interests includes robot perception, visual SLAM and 3D vision, using standard/event cameras for UAVs/UGVs, multi-beam/side-scan sonars for AUVs, etc. Detailed biography: [CV](http://halajun.github.io/files/Jun Zhang-Curriculum Vitae.pdf).
